---
name: promptpay-qr
description: Maintain PromptPay QR generation for the qr-gen static web app. Use when changing PromptPay payload construction, Thai mobile, citizen/tax ID, or e-wallet validation, amount normalization, QR filename rules, URL prefill behavior for PromptPay, EMV TLV ordering, CRC-16/CCITT-FALSE logic, or PromptPay payment-spec documentation.
---
...
4. Test at least one valid Thai mobile-number payload, one valid 13-digit citizen/tax ID payload, and one valid 15-digit e-wallet payload after changing PromptPay logic.
